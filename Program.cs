...
namespace CotofrecMaria3131B
{
    internal class SimpleWindow3D : GameWindow
    {
        ...
        private const String triangleFileName = @"C:\Users\PC\Desktop\OstrovschiArtur  -Laborator4\TriangleCoord.txt";
        private const String cubeFileName = @"C:\Users\PC\Desktop\OstrovschiArtur-Laborator4\CubeCoord.txt";
        ...
        public SimpleWindow3D() : base(800, 600, new GraphicsMode(32, 24, 0, 8))
        {
            ...
            for (int i = 0; i < 6; i++)
                colorsCube[i] = rando.RandomColor();
            VSync = VSyncMode.On;
